...
const Footer = () => {
  return (
    <div className='bg-green-900  grid md:grid-cols-5 gap-x-10  p-10'>
          ...
          <p className='mt-7 text-white text-xs hover:text-green-300 text-sm md:mt-3'>Our Terms of use</p>
          </Link>
          ...
          <Link to='/footerTermandcond'>
          <p className='mt-2 text-white text-xs hover:text-green-300 text-sm'>Terms and conditions</p>
          </Link>
          <Link to='/footerPrivacypolicy'>
          ...
          <Link to='/faq'>
          <p className='mt-7 text-white text-xs hover:text-green-300 text-sm md:mt-3'>FAQs</p>
          </Link>
          </div>
